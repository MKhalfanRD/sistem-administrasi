...
class AdminKttController extends Controller
{
    public function index(){
        ...
        return view('admin.ktt.index', compact(['ktt']));
    }
    ...
    public function create(){
        ...
        return view('admin.ktt.create', compact(['perusahaanUser', 'bulan', 'tahun']));
    }
    ...
    public function edit($id){
        ...
        return view('admin.ktt.edit', compact(['ktt' ,'perusahaanUser', 'bulan', 'tahun']));
    }

...
@section('content')
    <div class="Title">
        ...
        <form id="form" action="{{route('admin.sumberdaya.update', $sumberdaya->id)}}" method="POST" class="mx-auto mt-16 max-w-5xl grid grid-cols-1 gap-4 md:grid-cols-2" enctype="multipart/form-data">
            @csrf
            @method('PUT')

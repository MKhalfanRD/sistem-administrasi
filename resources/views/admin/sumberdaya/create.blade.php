...
@section('content')
    <div class="Title">
        ...
        <form action="{{route('admin.sumberdaya.store')}}" method="POST" class="mx-auto mt-16 max-w-5xl grid grid-cols-1 gap-4 md:grid-cols-2" enctype="multipart/form-data">
            @csrf
            ...
            <div class="flex flex-row gap-3">
                <a href="{{route('admin.sumberdaya.index')}}">
        ...
        document.getElementById('jenisSdm').addEventListener('change', function() {
            ...
            if (selectedValue === 'Tereka') {
                ...
                <div class="volumeTereka">
                    ...
                    <div class="">
                        <input type="text" id="volumeTereka" name="volumeTereka" class="bg-white block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
                </div>
                <div class="tonaseTereka">
                    ...
                    <div class="">
                        <input type="text" id="tonaseTereka" name="tonaseTereka" class="bg-white block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="volumeTertunjuk">
                    ...
                    <div class="">
                        <input type="text" id="volumeTertunjuk" name="volumeTertunjuk" class="bg-white block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
                </div>
                <div class="tonaseTertunjuk">
                    ...
                    <div class="">
                        <input type="text" id="tonaseTertunjuk" name="tonaseTertunjuk" class="bg-white block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                <div class="flex justify-end mt-4">
                    <button type="submit" class="px-3 py-1 text-sm font-semibold text-white bg-gray-500 rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-600">Simpan</button>
                ...
                <div class="tonaseTerukur">
                    ...
                    <div class="">
                        <input type="text" id="tonaseTerukur" name="tonaseTerukur" class="bg-white block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                <div class="flex justify-end mt-4">
                    <button type="submit" class="px-3 py-1 text-sm font-semibold text-white bg-gray-500 rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-600">Simpan</button>

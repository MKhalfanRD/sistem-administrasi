...
@section('content')
    <div class="Title">
        <div class="mx-auto max-w-2xl text-center">
            ...
            <p class="mt-2 text-lg leading-8 text-gray-600">Tambah Data Raw Inventory</p>
        </div>

        <form action="{{route('admin.rawInventory.store')}}" method="POST" class="mx-auto mt-16 max-w-xs" enctype="multipart/form-data">
            @csrf
            <div class="input-wrap">
                ...
                <div class="volumeRawInventori">
                    ...
                    <div class="mt-1.5 mb-3">
                        <input type="volumeRawInventori" name="volumeRawInventori" id="volumeRawInventori" value="{{old('volumeRawInventori') ?? ''}}" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            ...
            <div class="flex flex-row gap-3">
                <a href="{{route('admin.rawInventory.index')}}">

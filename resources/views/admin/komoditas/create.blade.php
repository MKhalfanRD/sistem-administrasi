...
@section('content')
    <div class="Title">
        ...
        <form id="form" action="{{route('admin.komoditas.store')}}" method="POST" class="mx-auto mt-16 max-w-xl grid grid-cols-1 md:grid-cols-2" enctype="multipart/form-data">
            @csrf
                ...
                <div class="komoditas">
                    ...
                    <div class="mt-1.5 mb-3">
                        <div class="dynamic-item flex gap-4">
                            <input type="text" name="inputs[0][komoditas]" id="komoditas" value="{{old('inputs.0.komoditas') ?? ''}}" class="w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">

...
@section('content')
    <div class="container mx-auto">
        ...
        <div class="button-wrap flex justify-between mt-3">
            ...
            <form action="{{ route('eksplor.search') }}" method="GET" class="mb-3">
                        ...
                        <tr
                            ...
                            {{-- <th scope="row"
                                ...
                                <div class="btn-wrap flex flex-row gap-3">
                                    <a href="{{ route('admin.eksplor.edit', $eksplor->id) }}">
                                        <button type="submit"
                                            class="bg-indigo-600 hover:bg-indigo-500 text-white px-5 py-2.5 rounded-lg">Edit</button>
                                    </a>
                                    <form action="{{ route('admin.eksplor.destroy', $eksplor->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button

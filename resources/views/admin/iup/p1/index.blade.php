...
@section('content')
    <div class="container mx-auto">
        <div class="mx-auto text-left">
            <h2 class="text-3xl font-bold tracking-tight sm:text-4xl">Table Perpanjangan 1</h2>
        </div>

        <div class="button-wrap flex justify-between mt-3">
            <a href="{{route('admin.p1.export')}}">
            ...
            <form action="{{ route('p1.search') }}" method="GET" class="mb-3">
                    ...
                    @foreach ($p1 as $p1)
                        <tr
                            ...
                            <td class="text-center font-medium whitespace-nowrap text-white">
                                @if ($p1->scanSK_p1)
                                    <a href="{{ asset('storage/' . $p1->scanSK_p1) }}" target="_blank">

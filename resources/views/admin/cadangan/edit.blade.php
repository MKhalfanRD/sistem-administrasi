...
@section('content')
    <div class="Title">
        ...
        <form action="{{route('admin.cadangan.update', $cadangan->id)}}" method="POST" class="mx-auto mt-16 max-w-5xl grid grid-cols-1 gap-4 md:grid-cols-2" enctype="multipart/form-data">
            @csrf
            @method('PUT ')
                    ...
                    <div class="komoditas">
                        ...
                        <div class="mt-1.5 mb-3">
                            ...
                            @foreach ($komoditas as $komoditas)
                                <option value="{{$komoditas}}" @if($komoditas == $cadangan->komoditas) selected @endif>{{$komoditas}}</option>
                            @endforeach
                            @endif
                            </select>
                            @error('komoditas')

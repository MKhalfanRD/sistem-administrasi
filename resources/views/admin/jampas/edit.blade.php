...
@section('content')
    <div class="Title">
        ...
        <form action="{{route('admin.jampas.update', $jampas->id)}}" method="POST" class="mx-auto mt-16 max-w-5xl grid grid-cols-1 gap-4 md:grid-cols-3" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="flex flex-row gap-3">
                <a href="{{route('admin.jampas.index')}}">

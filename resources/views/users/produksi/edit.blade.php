...
@section('content')
    <div class="Title">
        ...
        <form action="{{route('user.produksi.update', $produksi->id)}}" method="POST" class="mx-auto mt-16 max-w-xs" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="flex flex-row gap-3">
                <a href="{{route('user.produksi.index')}}">

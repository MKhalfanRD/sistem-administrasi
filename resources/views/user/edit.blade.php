        ...
        <form action="{{route('user.update', $userData->id)}}" method="POST" class="mx-auto mt-16 max-w-xs" enctype="multipart/form-data">
            ...
            <div class="input-wrap">
                ...
                <div class="email">
                    ...
                    <div class="mt-1.5 mb-3">
                        <input type="email" name="email" id="email" autocomplete="email" value="{{$userData->email}}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        @error('email')
                        <span class="text-red-500">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="password">
                    ...
                    <div class="mt-1.5 mb-3">
                        <input type="password" name="password" id="password" autocomplete="password" value="{{$userData->password}}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        @error('password')
                        <span class="text-red-500">{{$message}}</span>
                        @enderror
                    </div>

...
@section('content')
    <div class="Title">
        <div class="mx-auto max-w-2xl text-center">
            ...
            <p class="mt-2 text-lg leading-8 text-gray-600">Edit Data WIUP</p>
        </div>

        <form action="{{route('wiup.update', $IUP->id)}}" method="POST" class="mx-auto mt-16 max-w-5xl grid grid-cols-1 gap-4 md:grid-cols-3" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="input-wrap">
                <div class="namaPerusahaan mt-1.5 mb-3">
                    ...
                    <select name="namaPerusahaan" id="namaPerusahaan" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        ...
                        @foreach ($perusahaanUser as $namaPerusahaan)
                            <option value="{{$namaPerusahaan}}" @if($namaPerusahaan == $wiup->namaPerusahaan) selected @endif>{{$namaPerusahaan}}</option>
                        @endforeach
                        @endif
                    </select>
                </div>
                <div class="alamat">
                    ...
                    <div class="mt-1.5 mb-3">
                        <input type="text" name="alamat" id="alamat"value="{{$wiup->alamat}}" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        @error('alamat')
                ...
                <div class="npwp">
                    ...
                    <div class="mt-1.5 mb-3">
                        <input type="text" name="npwp" id="npwp" value="{{$wiup->npwp}}" class="bg-white block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        @error('npwp')
                        <span class="text-red-500">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="nib">
                    ...
                    <div class="mt-1.5 mb-3">
                        <input type="text" name="nib" id="nib" value="{{$wiup->nib}}" class="bg-white block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        @error('nib')
                        <span class="text-red-500">{{$message}}</span>
                        @enderror
                    </div>
            ...
            <div class="input-warp-2">
                    ...
                    <div class="mt-1.5 mb-3">
                        <select name="kabupaten" id="kabupaten" class="bg-white block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            ...
                            @foreach ($kabupaten as $kabupaten)
                                <option value="{{$kabupaten}}" @if($kabupaten == $wiup->kabupaten) selected @endif>{{$kabupaten}}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
                ...
                <div class="luasWilayah">
                    ...
                    <div class="mt-1.5 mb-3">
                        <input type="number" id="luasWilayah" name="luasWilayah" value="{{$wiup->luasWilayah}}" class="bg-white block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        @error('luasWilayah')
                        <span class="text-red-500">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="komoditas">
                        ...
                        <div class="mt-1.5 mb-3">
                            <input type="text" id="komoditas" name="komoditas" value="{{$wiup->komoditas}}" class="bg-white block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            @error('komoditas')
                            <span class="text-red-500">{{$message}}</span>
                            @enderror
                        </div>
                ...
                <div class="lokasiIzin">
                    ...
                    <div class="mt-1.5 mb-3">
                        <input type="text" id="lokasiIzin" name="lokasiIzin" value="{{$wiup->lokasiIzin}}" class="bg-white block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        @error('lokasiIzin')
                        <span class="text-red-500">{{$message}}</span>
                        @enderror
                    </div>
